...
export function pong_start() {
  ...
  create_scene();
  player_1.player_model = create_player(
    player_1.player_length,
    player_1.player_width,
    player_1.player_width,
    player_1.player_color,
    player_1.player_start_x,
    player_1.player_start_y,
    player_1.player_start_z
  );
  player_2.player_model = create_player(
    player_2.player_length,
    player_2.player_width,
    player_2.player_width,
    player_2.player_color,
    player_2.player_start_x,
    player_2.player_start_y,
    player_2.player_start_z
  );
...
function player_length() {
  player_1.player_min_length =
    player_1.player_model.position.x - player_1.player_length / 2;
  player_1.player_max_length =
    player_1.player_model.position.x + player_1.player_length / 2;
  player_2.player_min_length =
    player_2.player_model.position.x - player_2.player_length / 2;
  player_2.player_max_length =
    player_2.player_model.position.x + player_2.player_length / 2;
}
...
function ball_first_move() {
  ...
  if (ball.ball_is_move != 1) ball.ball_x_direction *= -1;
}

function ball_move() {
  if (
    ball.ball_model.position.x - ball.ball_radius <=
    (floor.floor_height / 2) * -1
  ) {
  ...
  if (
    ball.ball_model.position.z + ball.ball_radius <=
      player_2.player_model.position.z + player_2.player_width &&
    ball.ball_model.position.x <= player_2.player_max_length &&
    ball.ball_model.position.x >= player_2.player_min_length
  ) {
    if (
      player_2.player_model.position.z + player_2.player_width / 2 >=
      ball.ball_model.position.z - ball.ball_radius
    ) {
  ...
  if (
    ball.ball_model.position.z - ball.ball_radius >=
      player_1.player_model.position.z - player_2.player_width &&
    ball.ball_model.position.x <= player_1.player_max_length &&
    ball.ball_model.position.x >= player_1.player_min_length
  ) {
    ball.ball_z_direction *= -1;
  }
